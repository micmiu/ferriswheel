...
<head>
    ...
    <link type="text/css" rel="stylesheet" href="<c:url value='/static/plugins/easyui/1.3.2/themes/default/easyui.css'/>"/>
    ...
    <c:choose>
        <c:when test="${empty LOCALE}">
            <script type="text/javascript" src="<c:url value='/static/plugins/jquery-validation/1.9.0/messages_cn.js' />"></script>
            <script type="text/javascript" src="<c:url value='/static/plugins/easyui/1.3.2/locale/easyui-lang-zh_CN.js'/>"></script>
        </c:when>
        <c:otherwise>
