package com.micmiu.mvc.ferriswheel.support.hibernate;


import com.micmiu.mvc.ferriswheel.core.dao.jpa.BaseDao;
...
/**
 * 基础泛型Dao hibernate的实现
 *
 * @param <E>  实体类
 * @param <ID> 实体类ID类型
 * @author <a href="http://www.micmiu.com">Michael</a>
 * @version 1.0
 * @time Create on 2013-7-3 下午1:22:29
 */
@SuppressWarnings("unchecked")
public abstract class HibernateBaseDao<E extends FerriswheelID, ID extends Serializable> implements BaseDao<E, ID> {
	...
	public Long countAll() {
		return (Long) buildCriteria().setProjection(Projections.rowCount())
				.uniqueResult();
	}
	...
	public Long count(Map<String, Object> properties) {
		return (Long) buildCriteria(properties).setProjection(
